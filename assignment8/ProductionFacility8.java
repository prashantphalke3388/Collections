...
public class ProductionFacility8 implements Comparable<ProductionFacility8> {
   ...
   private int pliid;
    ...
    public ProductionFacility8(int pliid, String pro_facility_name, String pro_fa_location, int totalproduction_perday,
   ...
   @Override
    public int compareTo(ProductionFacility8 o) {
...
class ProductionFacilityOnDate implements Comparator<ProductionFacility8>{
...
class ProductionFacilityOnItem implements Comparator<ProductionFacility8>{
